...
export default function FloatingBotTooltip() {
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-center gap-2 w-fit bg-[#113361]/80 p-2 rounded-lg border border-[#fff]/50     transition-shadow duration-300
hover:shadow-[0_0_15px_1px_#ffffff]">
        ...
        />
        <p className="text-white" style={{fontSize: "12px"}}> Start a New Conversation</p>
        </div>
      </Link>
    </motion.div>
  );
