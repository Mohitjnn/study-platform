    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate="open"
          exit="closed"
          className="fixed top-32 left-1/2 transform -translate-x-1/2 w-full z-50 text-white md:max-w-3xl mx-auto lg:px-8"
        >
          <div className="px-2 pt-2 pb-3 space-y-1 border-t bg-white/20 backdrop-blur-sm text-white shadow-lg">
