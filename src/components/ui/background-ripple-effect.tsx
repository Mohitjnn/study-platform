...
export const BackgroundRippleEffect = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "absolute inset-0 h-full w-full md:max-w-3xl md:mx-auto",
        "[--cell-border-color:var(--color-neutral-300)] [--cell-fill-color:#090E6C] [--cell-shadow-color:var(--color-neutral-500)]",
